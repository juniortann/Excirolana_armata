...
metaData.ecoCode.climate = {'MB'}; %changed from MA (tropical) to subptropical, based on T_typ and T for data
...
comment.tL = 'Adult, extracted from a plot (Fig 5) manually';
...
% D3 = 'tL data modeled with a sinusoid temp fluctuation'
