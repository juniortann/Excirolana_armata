...
metaData.data_0     = {'ab'; 'am'; 'Lb'; 'Lp'; 'Li'; 'Ri'}; % 'Wwb';  'Wwp'; 'Wwi'; 
...
data.ab = 60;    units.ab = 'd';    label.ab = 'age at birth';                bibkey.ab = 'Petracco2010';   
  temp.ab = C2K(22.9);  units.temp.ab = 'K'; label.temp.ab = 'temperature';
...
data.am = data.ab+1.93*365; units.am = 'd';    label.am = 'life span';                   bibkey.am = 'Petracco2010';  
...
data.Ri = 18/60;  units.Ri = '#/d';  label.Ri = 'maximum reprod rate';     bibkey.Ri = 'Petracco2010';  
  temp.Ri = C2K(25.6); units.temp.Ri = 'K'; label.temp.Ri = 'temperature';
  comment.Ri = '18 eggs, with incubation period of two months'; 
...
temp.tL   = C2K(22.9);  units.temp.tL = 'K'; label.temp.tL = 'temperature';
...
temp.LN   = C2K(22.9);  units.temp.LN = 'K'; label.temp.LN = 'temperature';
...
%% Group plots
% set1 = {'tL_f','tL_m'}; comment1 = {'Data at females, males'};
